...
count = len(oss.listdir("F:\\Projects\\sign_language_translator\\Data\\asl_alphabet_train\\asl_alphabet_train\\A\\"))
c_dir = 'A'
...
cv2.imwrite("F:\\Projects\\sign_language_translator\\white.jpg",white)
...
while True:
    try:
        ...
        white = cv2.imread("F:\\Projects\\sign_language_translator\\white.jpg")
